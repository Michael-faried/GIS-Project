...
Output_Points = r'E:\8th Semester\GIS\GIS Application\Output\Task10_output\output_shapefile.shp'

arcpy.CopyFeatures_management(countries, Output_Points)

with arcpy.da.UpdateCursor(Output_Points,['FID','NAME','POP_EST','POP_YEAR','FEATURECLA']) as countres_cursor:
